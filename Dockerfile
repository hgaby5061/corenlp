...
CMD ["java", "-mx3g", "-cp", "/app/stanford-corenlp-4.5.0/*:/app/libs/*", "edu.stanford.nlp.pipeline.StanfordCoreNLPServer", "-port", "9000", "-timeout", "15000", "-logLevel", "DEBUG","-modeldir","/app/stanford-corenlp-4.5.0/"]
